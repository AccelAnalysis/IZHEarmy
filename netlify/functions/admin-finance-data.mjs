...
import { organizationAccountability, LEDGER_TYPES } from './_shared/accountability-rules.mjs';
...
export default async (request) => {
  ...
  try {
    ...
    return json({ ...organizationAccountability(campaigns, { orders, codes, redemptions, batches }, ledger), ledgerTypes: LEDGER_TYPES }, 200, { 'cache-control': 'no-store' });
  } catch (error) {
