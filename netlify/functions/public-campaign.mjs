...
export default async (request) => {
  ...
  try {
    ...
    const [{ catalog }, orders, codes, redemptions, batches, ledger] = await Promise.all([loadCatalog(), listStoreJSON('izhe-orders'), listStoreJSON('izhe-give-codes'), listStoreJSON('izhe-redemptions'), listStoreJSON('izhe-production-batches'), listLedgerEntries()]);
