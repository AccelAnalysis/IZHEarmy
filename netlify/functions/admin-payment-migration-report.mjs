...
export default async (request) => {
  ...
  try {
    ...
    console.error('admin-payment-migration-report', String(error?.message || error).slice(0, 500));
    return json({ error: 'Legacy payment migration report could not be generated.' }, 500);
  }
};
