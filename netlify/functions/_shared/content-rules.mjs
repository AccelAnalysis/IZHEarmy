...
export const CONTENT_SCHEMAS = {
  'site-seo': {
    label: 'Site search and sharing',
    fields: {
      title: { label: 'Browser title', type: 'text', max: 180 },
      description: { label: 'Search description', type: 'textarea', max: 500 },
      socialTitle: { label: 'Social sharing title', type: 'text', max: 180 },
      socialDescription: { label: 'Social sharing description', type: 'textarea', max: 500 },
      socialImage: { label: 'Social sharing image URL', type: 'url', max: 1200 }
    }
  },
  'home-hero': {
    label: 'Home hero',
  ...
  'home-story': {
    ...
    fields: {
      ...
      accent: { label: 'Accent line', type: 'text', max: 180 },
      paragraph1: { label: 'First paragraph', type: 'textarea', max: 1800 },
      paragraph2: { label: 'Second paragraph', type: 'textarea', max: 1800 },
      image: { label: 'Story image URL', type: 'url', max: 1200 },
      imageAlt: { label: 'Story image description', type: 'text', max: 240 }
    }
  },
  'home-book': {
    label: 'Home book feature',
    fields: {
      eyebrow: { label: 'Eyebrow', type: 'text', max: 140 },
      heading: { label: 'Book title', type: 'text', max: 220 },
      subtitle: { label: 'Book subtitle', type: 'text', max: 240 },
      body: { label: 'Book introduction', type: 'textarea', max: 1800 },
      previewLabel: { label: 'Preview button label', type: 'text', max: 100 },
      libraryLabel: { label: 'Teaching library button label', type: 'text', max: 100 },
      backgroundImage: { label: 'Background image URL', type: 'url', max: 1200 }
    }
  },
  'home-give-one': {
    label: 'Give One section',
    fields: {
      eyebrow: { label: 'Eyebrow', type: 'text', max: 120 },
      heading: { label: 'Heading', type: 'text', max: 220 },
      body: { label: 'Explanation', type: 'textarea', max: 2200 }
    }
  },
  'home-church': {
    label: 'Churches and ministries section',
    fields: {
      eyebrow: { label: 'Eyebrow', type: 'text', max: 120 },
      heading: { label: 'Heading', type: 'text', max: 220 },
      body: { label: 'Invitation', type: 'textarea', max: 2200 },
      backgroundImage: { label: 'Background image URL', type: 'url', max: 1200 },
      submitLabel: { label: 'Form button label', type: 'text', max: 100 }
    }
  },
  'site-announcement': {
...
export function validateContentRecord(input, existing = null) {
  ...
  return {
    ...
    status,
    fields,
    publishAt: input?.publishAt ? new Date(input.publishAt).toISOString() : '',
...
export function publicContent(library, { preview = false, now = new Date() } = {}) {
  ...
  return {
    revision: Number(library?.revision || 1),
    updatedAt: library?.updatedAt || '',
    preview,
    records: Object.fromEntries(records.map((record) => [record.key, { key: record.key, label: record.label, fields: record.fields, status: record.status, updatedAt: record.updatedAt }]))
  };
}
