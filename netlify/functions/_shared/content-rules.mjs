...
const imageFocalPoint = (label) => choice(label, ['top', 'center', 'bottom', 'left', 'right']);
const imageFit = (label) => choice(label, ['cover', 'contain']);
const imageOverlay = (label) => choice(label, ['none', 'light', 'medium', 'strong']);
...
export const CONTENT_SCHEMAS = {
  ...
  'home-story': { label: 'Home story', fields: { eyebrow: { label: 'Eyebrow', type: 'text', max: 120 }, heading: { label: 'Heading', type: 'text', max: 220 }, accent: { label: 'Accent line', type: 'text', max: 180 }, paragraph1: { label: 'First paragraph', type: 'textarea', max: 1800 }, paragraph2: { label: 'Second paragraph', type: 'textarea', max: 1800 }, image: { label: 'Story image URL', type: 'url', max: 1200 }, imageAlt: { label: 'Story image description', type: 'text', max: 240 }, imageFocalPoint: imageFocalPoint('Story image focal point'), imageFit: imageFit('Story image fit'), imageOverlay: imageOverlay('Story image overlay'), imageEyebrow: { label: 'Image eyebrow', type: 'text', max: 100 }, imageStatement: { label: 'Image statement', type: 'text', max: 120 }, card1Title: { label: 'First feature title', type: 'text', max: 120 }, card1Body: { label: 'First feature description', type: 'textarea', max: 500 }, card2Title: { label: 'Second feature title', type: 'text', max: 120 }, card2Body: { label: 'Second feature description', type: 'textarea', max: 500 } } },
  ...
  'home-give-one': { label: 'Give One section', fields: { eyebrow: { label: 'Eyebrow', type: 'text', max: 120 }, heading: { label: 'Heading', type: 'text', max: 220 }, body: { label: 'Explanation', type: 'textarea', max: 2200 }, step1Title: { label: 'Step 1 title', type: 'text', max: 100 }, step1Body: { label: 'Step 1 description', type: 'textarea', max: 500 }, step2Title: { label: 'Step 2 title', type: 'text', max: 100 }, step2Body: { label: 'Step 2 description', type: 'textarea', max: 500 }, step3Title: { label: 'Step 3 title', type: 'text', max: 100 }, step3Body: { label: 'Step 3 description', type: 'textarea', max: 500 }, image: { label: 'Purpose image URL', type: 'url', max: 1200 }, imageAlt: { label: 'Purpose image description', type: 'text', max: 240 }, imageFocalPoint: imageFocalPoint('Purpose image focal point'), imageFit: imageFit('Purpose image fit'), imageOverlay: imageOverlay('Purpose image overlay'), purposeEyebrow: { label: 'Purpose eyebrow', type: 'text', max: 100 }, purposeHeading: { label: 'Purpose heading', type: 'text', max: 180 }, purposeBody: { label: 'Purpose description', type: 'textarea', max: 700 } } },
